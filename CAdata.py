...
def create_app_ui():
    ...
    children = 
    [
     html.H1('CDR Analysis with Insights', id='Main_title' , style = { 'text-align':'center'}), 
     
     dcc.Tabs(id = 'Tabs', value = 'Tabs', children = [     
        dcc.Tab(id = 'Call Analytics tool', label = 'Call Analytics tool', value = 'Call Analytics tool' ,
            children  = [ 
      ...
      dcc.Tab( id = 'Service Analytics tool', label = 'Service Analytics tool', value = 'Service Analytics tool'),
      dcc.Tab( id = 'Device Analytics tool' , label = 'Device Analytics tool', value = 'Device Analytics tool')
